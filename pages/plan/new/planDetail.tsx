    ...
    <>
      <div className="flex h-screen w-full flex-col justify-center bg-black text-white">
        <div className="mx-auto flex h-full w-full max-w-2xl flex-col items-center md:max-w-7xl">
          <h1 className="pt-20 pb-10 text-4xl font-bold">경주 역사탐방</h1>
          ...
          <div className="flex w-full justify-around pt-12">
            <div className="flex flex-col items-center justify-center">
              <p className="text-lg">일정</p>
              <p className="pt-3 text-2xl font-semibold">
                {convertDateToKorean(plan.start, plan.end)}
              </p>
            </div>
            <div className="flex flex-col items-center justify-center">
              <p className="text-lg">예상경비</p>
              <p className="pt-3 text-2xl font-semibold">약7만원</p>
              <p className="text-sm text-blue-500">
                예산보다 3만원 더 적습니다!
              </p>
            </div>
            <div className="flex flex-col items-center justify-center">
              <p className="text-lg">관광시간</p>
              <p className="pt-3 text-2xl font-semibold">약5시간</p>
            </div>
          </div>
          <div className="mt-14 w-full max-w-2xl md:max-w-5xl">
            <div className="flex h-80 w-full items-center justify-center rounded-lg bg-[#434343]">
              <div className="flex h-[85%] w-[92%]">
                ...
                <div className="flex h-full w-1/4 flex-col items-center justify-evenly space-y-2 pl-4 md:pl-12">
            ...
            <div className="mt-12 flex w-full justify-center font-bold">
              <button
                ...
                className="rounded-lg bg-white py-6 px-24 text-black"
              >
                계획생성
              </button>
            </div>
        ...
        <div>
          <div className="mx-auto flex h-full w-full max-w-2xl flex-col items-center md:max-w-7xl">
            <p className="pt-20 pb-10 text-2xl font-bold">
              {travels[0].destination.title}
            </p>
          </div>
        </div>
