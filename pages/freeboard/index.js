            ...
            <div className="flex h-full w-full">
              <div className="flex w-1/4 ">
                <div className="flex w-full flex-col items-center">
                  <div className="mt-10 h-9 w-2/3 border-solid border-gray-300">
                    <Link
                      href={{ pathname: "/QnA", query: { page: 1 } }}
                      legacyBehavior
                    >
                      <a>
                        <h2 className="border-b-2 border-solid border-gray-300 pl-1 text-lg">
                          질의응답
                        </h2>
                      </a>
                    </Link>
                  </div>
                  <div className="h-9 w-2/3 border-b-2 border-solid">
                  ...
                  <div className="h-9 w-2/3 border-b-2 border-solid border-gray-300 bg-sky-600">
                    <Link href="/freeboard" legacyBehavior>
                      <a>
                        <h2 className="pl-1 text-lg text-white">자유게시판</h2>
                      </a>
                    </Link>
                  </div>
                </div>
              ...
              <div className="w-3/4">
                <div className="flex h-32 w-full justify-between bg-white">
                  <h1 className="mt-8 text-3xl">자유게시판</h1>
